...
const staticFiles = [
  ...
  ...["boarding-layout.js", "boarding-combat.js", "boarding-controller.js", "boarding-renderer.js", "crew-rig.js"].map(name=>[join("src",name),join("src",name)]),
  ...
  [join("src", "enemy-defense.js"), join("src", "enemy-defense.js")],
  ...
  [join("src", "flight-camera.js"), join("src", "flight-camera.js")],
  [join("src", "boarding-ship.js"), join("src", "boarding-ship.js")],
