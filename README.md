...
- Hull durability is separate from crew HP: 100 hull, 25 damage per cannon hit. Four physical foredeck lamps and edge damage tint replace an extra HUD panel. Four hits disable flight; **다시 도전** at the bottom restores hull and restarts at 220 m. Pause/settings freeze AI and projectiles. A lodged harpoon arrests enemy yaw and cancels its weapons for boarding.
