...
- While orbiting or stopped, aim at the ramp and select **작살 발사 / F**. There is no orbit-stop requirement. A ray must hit the visible ramp from a near-rear angle. Looking at the ship's centre from the front cannot succeed.
