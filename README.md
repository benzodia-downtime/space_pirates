...
- Killing the guard does not end boarding. Approach the fallen body and press **E / 시신 수색** to carry its supplies. Walk back while alive and pull the physical **분리 레버** in your lower airlock to bank supplies, disconnect and return to the cockpit. You may retreat without killing anyone or taking loot.
